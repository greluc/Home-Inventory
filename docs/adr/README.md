...
| ADR | Title | Status |
|---|---|---|
| [0000](0000-open-points.md) | Open points | ongoing |
...
| [0007](0007-media-storage.md) | A BlobStore port with filesystem, S3 and Nextcloud adapters | Accepted |
| [0008](0008-search.md) | OpenSearch as a derived read model | Accepted |
| [0009](0009-messaging-and-events.md) | RabbitMQ with a transactional outbox | Accepted |
...
| [0014](0014-offline-synchronization.md) | Full bidirectional sync with a three-way compare | Accepted |
| [0015](0015-deployment.md) | Docker Compose primary, Helm maintained as an equal | Partially superseded by 0021, 0022 |
| [0016](0016-identifiers.md) | UUIDv7 internally, a separate public short code | Accepted |
...
| [0023](0023-push-notifications.md) | Push through Firebase and APNs as a plugin, content-free payload | Accepted |
| [0024](0024-malware-scan.md) | A mandatory malware scan, fail-closed | Accepted |
