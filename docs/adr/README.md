...
| ADR | Title | Status |
|---|---|---|
| [0000](0000-open-points.md) | Open points | ongoing — **none open** |
...
| [0027](0027-egress-enforcement.md) | Egress enforcement: deny-all for the core, a proxy per plugin segment | Accepted |
