...
| REQ-NFR-063 | A **service matrix** (`deploy/services.yaml`) is the source of truth; the Quadlet units and `compose.yaml` are generated from it and the Helm chart is validated against it. | M | 0 | A hand-written deviation fails the CI comparison |
